...
public class JiangxuejinshenqingController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params, JiangxuejinshenqingEntity jiangxuejinshenqing, HttpServletRequest request) {

        String tableName = request.getSession().getAttribute("tableName").toString();
        if (tableName.equals("xuesheng")) {
            jiangxuejinshenqing.setXueshengzhanghao((String) request.getSession().getAttribute("username"));
        }
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params, JiangxuejinshenqingEntity jiangxuejinshenqing, HttpServletRequest request) {
        EntityWrapper<JiangxuejinshenqingEntity> ew = new EntityWrapper<JiangxuejinshenqingEntity>();
        PageUtils page = jiangxuejinshenqingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jiangxuejinshenqing), params), params));
        return R.ok().put("data", page);
    }
