<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="奖学金名称" prop="jiangxuejinmingcheng">
            <el-input v-model="ruleForm.jiangxuejinmingcheng"
                      placeholder="奖学金名称" clearable :readonly="ro.jiangxuejinmingcheng"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="奖学金名称" prop="jiangxuejinmingcheng">
              <el-input v-model="ruleForm.jiangxuejinmingcheng"
                        placeholder="奖学金名称" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="奖学金类型" prop="jiangxuejinleixing">
            <el-input v-model="ruleForm.jiangxuejinleixing"
                      placeholder="奖学金类型" clearable :readonly="ro.jiangxuejinleixing"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="奖学金类型" prop="jiangxuejinleixing">
              <el-input v-model="ruleForm.jiangxuejinleixing"
                        placeholder="奖学金类型" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="奖金" prop="jiangjin">
            <el-input v-model="ruleForm.jiangjin"
                      placeholder="奖金" clearable :readonly="ro.jiangjin"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="奖金" prop="jiangjin">
              <el-input v-model="ruleForm.jiangjin"
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="家庭成员人数" prop="jiatingchengyuanrenshu">
            <el-input v-model="ruleForm.jiatingchengyuanrenshu"
                      placeholder="家庭成员人数" clearable :readonly="ro.jiatingchengyuanrenshu"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="家庭成员人数" prop="jiatingchengyuanrenshu">
              <el-input v-model="ruleForm.jiatingchengyuanrenshu"
                        placeholder="家庭成员人数" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="年收入" prop="nianshouru">
            <el-input v-model="ruleForm.nianshouru"
                      placeholder="年收入" clearable :readonly="ro.nianshouru"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="年收入" prop="nianshouru">
              <el-input v-model="ruleForm.nianshouru"
        ...
        <el-col :span="24">
          <el-form-item class="upload" v-if="type!='info'" label="申请表" prop="shenqingbiao">
            <file-upload
                tip="点击上传申请表"
                action="file/upload"
                :limit="1"
                :multiple="true"
                :fileUrls="ruleForm.shenqingbiao?ruleForm.shenqingbiao:''"
                @change="shenqingbiaoUploadChange"
            ></file-upload>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.shenqingbiao" label="申请表" prop="shenqingbiao">
              <el-button type="text" size="small" @click="download(ruleForm.shenqingbiao)">下载</el-button>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item v-if="type!='info'" label="具体家庭情况" prop="jutijiatingqingkuang">
            <editor
                style="min-width: 200px; max-width: 600px;"
                v-model="ruleForm.jutijiatingqingkuang"
                class="editor"
                action="file/upload">
            </editor>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.jutijiatingqingkuang" label="具体家庭情况" prop="jutijiatingqingkuang">
              <span v-html="ruleForm.jutijiatingqingkuang"></span>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro: {
        jiangxuejinmingcheng: false,
        jiangxuejinleixing: false,
        jiangjin: false,
  ...
  methods: {
    ...
    init(id, type) {
      ...
      if (this.type == 'info' || this.type == 'else') {
        ...
        for (var o in obj) {
          if (o == 'jiangxuejinmingcheng') {
            this.ruleForm.jiangxuejinmingcheng = obj[o];
            this.ro.jiangxuejinmingcheng = true;
            continue;
          }
          if (o == 'jiangxuejinleixing') {
            this.ruleForm.jiangxuejinleixing = obj[o];
            this.ro.jiangxuejinleixing = true;
            continue;
          }
          if (o == 'jiangjin') {
          ...
          if (o == 'jiatingchengyuanrenshu') {
            this.ruleForm.jiatingchengyuanrenshu = obj[o];
            this.ro.jiatingchengyuanrenshu = true;
            continue;
          }
          if (o == 'nianshouru') {
            this.ruleForm.nianshouru = obj[o];
            this.ro.nianshouru = true;
            continue;
          }
          if (o == 'shenqingbiao') {
            this.ruleForm.shenqingbiao = obj[o];
            this.ro.shenqingbiao = true;
            continue;
          }
          ...
          if (o == 'jutijiatingqingkuang') {
            this.ruleForm.jutijiatingqingkuang = obj[o];
            this.ro.jutijiatingqingkuang = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          if (json.jiatingdizhi != '' && json.jiatingdizhi) {
    ...
    info(id) {
      this.$http({
        url: `jiangxuejinshenqing/info/${id}`,
        method: "get"
      }).then(({data}) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiangxuejinshenqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({data}) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiangxuejinshenqingCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    shenqingbiaoUploadChange(fileUrls) {
      this.ruleForm.shenqingbiao = fileUrls;
      this.addEditUploadStyleChange()
    },
    addEditStyleChange() {
      this.$nextTick(() => {
