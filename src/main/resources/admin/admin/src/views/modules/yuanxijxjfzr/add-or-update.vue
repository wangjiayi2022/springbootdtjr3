<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="院系奖学金负责人工号" prop="yuanxijxjfzrgonghao">
          <el-input v-model="ruleForm.yuanxijxjfzrgonghao" 
              placeholder="院系奖学金负责人工号" clearable  :readonly="ro.yuanxijxjfzrgonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="院系奖学金负责人工号" prop="yuanxijxjfzrgonghao">
              <el-input v-model="ruleForm.yuanxijxjfzrgonghao" 
                placeholder="院系奖学金负责人工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="院系奖学金负责人姓名" prop="yuanxijxjfzrxingming">
          <el-input v-model="ruleForm.yuanxijxjfzrxingming" 
              placeholder="院系奖学金负责人姓名" clearable  :readonly="ro.yuanxijxjfzrxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="院系奖学金负责人姓名" prop="yuanxijxjfzrxingming">
              <el-input v-model="ruleForm.yuanxijxjfzrxingming" 
                placeholder="院系奖学金负责人姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	yuanxijxjfzrgonghao : false,
	yuanxijxjfzrxingming : false,
	mima : false,
	xingbie : false,
	lianxidianhua : false,
            ...
            ruleForm: {
                	        yuanxijxjfzrgonghao: '',
	                        	        ...
	                        	        jiaoshiyouxiang: '',
                                                ...
                                                rules: {
                  yuanxijxjfzrgonghao: [
                            { required: true, message: '院系奖学金负责人工号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  yuanxijxjfzrxingming: [
                            { required: true, message: '院系奖学金负责人姓名不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='yuanxijxjfzrgonghao'){
            this.ruleForm.yuanxijxjfzrgonghao = obj[o];
	    this.ro.yuanxijxjfzrgonghao = true;
            continue;
          }
	            	            if(o=='yuanxijxjfzrxingming'){
            this.ruleForm.yuanxijxjfzrxingming = obj[o];
	    this.ro.yuanxijxjfzrxingming = true;
            continue;
          }
	            	            if(o=='mima'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yuanxijxjfzr/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuanxijxjfzrCrossAddOrUpdateFlag = false;
                  this.parent.search();
