<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item v-if="type!='info'" label="具体内容" prop="jutineirong">
            <editor
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.jutineirong" label="具体内容" prop="jutineirong">
              <span v-html="ruleForm.jutineirong"></span>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id, type) {
      ...
      if (this.type == 'info' || this.type == 'else') {
        ...
        for (var o in obj) {
          ...
          if (o == 'jutineirong') {
            this.ruleForm.jutineirong = obj[o];
            this.ro.jutineirong = true;
            continue;
          }
          if (o == 'fabushijian') {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiangchengxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({data}) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiangchengxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
