  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="select" v-if="type!='info'" label="奖学金类型" prop="jiangxuejinleixing">
            <el-select v-model="ruleForm.jiangxuejinleixing" placeholder="请选择奖学金类型">
              <el-option
                  v-for="(item,index) in jiangxuejinleixingOptions"
                  v-bind:key="index"
                  :label="item"
                  :value="item">
              </el-option>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item v-if="type!='info'" label="申请条件" prop="shenqingtiaojian">
            <editor
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.shenqingtiaojian" label="申请条件" prop="shenqingtiaojian">
              <span v-html="ruleForm.shenqingtiaojian"></span>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiangxuejinxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({data}) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiangxuejinxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
