<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="教务处工号" prop="jiaowuchugonghao">
            <el-input v-model="ruleForm.jiaowuchugonghao"
                      placeholder="教务处工号" clearable :readonly="ro.jiaowuchugonghao"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="教务处工号" prop="jiaowuchugonghao">
              <el-input v-model="ruleForm.jiaowuchugonghao"
                        placeholder="教务处工号" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="教务姓名" prop="jiaowuxingming">
            <el-input v-model="ruleForm.jiaowuxingming"
                      placeholder="教务姓名" clearable :readonly="ro.jiaowuxingming"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="教务姓名" prop="jiaowuxingming">
              <el-input v-model="ruleForm.jiaowuxingming"
                        placeholder="教务姓名" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro: {
        jiaowuchugonghao: false,
        mima: false,
        jiaowuxingming: false,
        xingbie: false,
        lianxidianhua: false,
      ...
      rules: {
        jiaowuchugonghao: [
          {required: true, message: '教务处工号不能为空', trigger: 'blur'},
        ],
        mima: [
          {required: true, message: '密码不能为空', trigger: 'blur'},
        ],
        jiaowuxingming: [
          {required: true, message: '教务姓名不能为空', trigger: 'blur'},
        ],
        xingbie: [],
        lianxidianhua: [
  ...
  methods: {
    ...
    init(id, type) {
      ...
      if (this.type == 'info' || this.type == 'else') {
        ...
        for (var o in obj) {
          if (o == 'jiaowuchugonghao') {
            this.ruleForm.jiaowuchugonghao = obj[o];
            this.ro.jiaowuchugonghao = true;
            continue;
          }
          if (o == 'mima') {
          ...
          if (o == 'jiaowuxingming') {
            this.ruleForm.jiaowuxingming = obj[o];
            this.ro.jiaowuxingming = true;
            continue;
          }
          if (o == 'xingbie') {
