<template>
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '奖学金名称' : ''">
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '奖学金类型' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search"
                      v-model="searchForm.jiangxuejinleixing" placeholder="奖学金类型" clearable></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search"
                      v-model="searchForm.jiangxuejinleixing" placeholder="奖学金类型" clearable></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.jiangxuejinleixing" placeholder="奖学金类型"
                      clearable></el-input>
          </el-form-item>
          <el-form-item>
        ...
        <el-row class="ad"
          ...
          <el-form-item>
            <el-button
                v-if="isAuth('jiangxuejinxinxi','新增') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 1"
                type="success"
                icon="el-icon-plus"
            ...
            <el-button
                v-if="isAuth('jiangxuejinxinxi','新增') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2"
                type="success"
                @click="addOrUpdateHandler()"
            >{{ contents.btnAdAllFont == 1 ? '新增' : '' }}<i class="el-icon-plus el-icon--right"/></el-button>
            <el-button
                v-if="isAuth('jiangxuejinxinxi','新增') && contents.btnAdAllIcon == 0"
                type="success"
                @click="addOrUpdateHandler()"
            >{{ contents.btnAdAllFont == 1 ? '新增' : '' }}
            </el-button>
            <el-button
                v-if="isAuth('jiangxuejinxinxi','删除') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 1 && contents.tableSelection"
            ...
            <el-button
                v-if="isAuth('jiangxuejinxinxi','删除') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2 && contents.tableSelection"
                :disabled="dataListSelections.length <= 0"
                type="danger"
                @click="deleteHandler()"
            >{{ contents.btnAdAllFont == 1 ? '删除' : '' }}<i class="el-icon-delete el-icon--right"/></el-button>
            <el-button
                v-if="isAuth('jiangxuejinxinxi','删除') && contents.btnAdAllIcon == 0 && contents.tableSelection"
                :disabled="dataListSelections.length <= 0"
                type="danger"
                @click="deleteHandler()"
            >{{ contents.btnAdAllFont == 1 ? '删除' : '' }}
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                  ...
                  v-if="isAuth('jiangxuejinxinxi','查看')"
                  :data="dataList"
          ...
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                           prop="jiangxuejinmingcheng"
                           header-align="center"
                           label="奖学金名称">
            <template slot-scope="scope">
              {{ scope.row.jiangxuejinmingcheng }}
            </template>
          </el-table-column>
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                           prop="jiangxuejinleixing"
                           header-align="center"
                           label="奖学金类型">
            <template slot-scope="scope">
              {{ scope.row.jiangxuejinleixing }}
            </template>
          </el-table-column>
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                           prop="jiangjin"
          ...
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="shenqingbiao"
                           header-align="center"
                           label="申请表">
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="download(scope.row.shenqingbiao)">下载</el-button>
            </template>
          </el-table-column>
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                           prop="fabushijian"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              <el-button
                  v-if="isAuth('jiangxuejinxinxi','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="success" icon="el-icon-tickets" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">
                {{ contents.tableBtnFont == 1 ? '详情' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('jiangxuejinxinxi','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('jiangxuejinxinxi','查看') && contents.tableBtnIcon == 0" type="success" size="mini"
                         @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1 ? '详情' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('jiangxuejinxinxi','申请') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="success" icon="el-icon-tickets" size="mini"
                  @click="jiangxuejinshenqingCrossAddOrUpdateHandler(scope.row,'cross')">
                {{ contents.tableBtnFont == 1 ? '申请' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('jiangxuejinxinxi','申请') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
                  type="success" size="mini" @click="jiangxuejinshenqingCrossAddOrUpdateHandler(scope.row,'cross')">
                {{ contents.tableBtnFont == 1 ? '申请' : '' }}<i class="el-icon-tickets el-icon--right"/></el-button>
              <el-button v-if="isAuth('jiangxuejinxinxi','申请') && contents.tableBtnIcon == 0" type="success" size="mini"
                         @click="jiangxuejinshenqingCrossAddOrUpdateHandler(scope.row,'cross')">
                {{ contents.tableBtnFont == 1 ? '申请' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('jiangxuejinxinxi','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="primary" icon="el-icon-edit" size="mini" @click="addOrUpdateHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('jiangxuejinxinxi','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('jiangxuejinxinxi','修改') && contents.tableBtnIcon == 0" type="primary" size="mini"
                         @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>


              <el-button
                  v-if="isAuth('jiangxuejinxinxi','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '删除' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('jiangxuejinxinxi','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('jiangxuejinxinxi','删除') && contents.tableBtnIcon == 0" type="danger" size="mini"
    ...
    <jiangxuejinshenqing-cross-add-or-update v-if="jiangxuejinshenqingCrossAddOrUpdateFlag" :parent="this"
                                             ref="jiangxuejinshenqingCrossaddOrUpdate"></jiangxuejinshenqing-cross-add-or-update>
...
import jiangxuejinshenqingCrossAddOrUpdate from "../jiangxuejinshenqing/add-or-update";

export default {
  data() {
    return {
      jiangxuejinleixingOptions: [],
      searchForm: {
        key: ""
      },
      dataList: [],
      ...
      jiangxuejinshenqingCrossAddOrUpdateFlag: false,
      contents: {
  ...
  components: {
    AddOrUpdate,
    jiangxuejinshenqingCrossAddOrUpdate,
  },
  methods: {
    contentStyleChange() {
    ...
    jiangxuejinshenqingCrossAddOrUpdateHandler(row, type) {
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.jiangxuejinshenqingCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj', row);
      this.$storage.set('crossTable', 'jiangxuejinxinxi');
      this.$nextTick(() => {
        this.$refs.jiangxuejinshenqingCrossaddOrUpdate.init(row.id, type);
      });
    },
    init() {
      this.$http({
        url: `option/jiangxuejinleixing/jiangxuejinleixing`,
        method: "get"
      }).then(({data}) => {
        if (data && data.code === 0) {
          this.jiangxuejinleixingOptions = data.data;
        } else {
    ...
    getDataList() {
      ...
      if (this.searchForm.jiangxuejinmingcheng != '' && this.searchForm.jiangxuejinmingcheng != undefined) {
        params['jiangxuejinmingcheng'] = '%' + this.searchForm.jiangxuejinmingcheng + '%'
      }
      if (this.searchForm.jiangxuejinleixing != '' && this.searchForm.jiangxuejinleixing != undefined) {
        params['jiangxuejinleixing'] = '%' + this.searchForm.jiangxuejinleixing + '%'
      }
      this.$http({
        url: "jiangxuejinxinxi/page",
        method: "get",
        params: params
      }).then(({data}) => {
        if (data && data.code === 0) {
