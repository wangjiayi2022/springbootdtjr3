  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="家庭情况" prop="jiatingqingkuang">
            <el-input v-model="ruleForm.jiatingqingkuang"
                      placeholder="家庭情况" clearable :readonly="ro.jiatingqingkuang"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="家庭情况" prop="jiatingqingkuang">
              <el-input v-model="ruleForm.jiatingqingkuang"
                        placeholder="家庭情况" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
