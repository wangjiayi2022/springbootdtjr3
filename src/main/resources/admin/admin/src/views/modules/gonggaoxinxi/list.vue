        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              ...
              <el-button v-if="isAuth('gonggaoxinxi','查看') && contents.tableBtnIcon == 0" type="success" size="mini"
              ...
              <el-button v-if="isAuth('gonggaoxinxi','修改') && contents.tableBtnIcon == 0" type="primary" size="mini"
              ...
              <el-button v-if="isAuth('gonggaoxinxi','删除') && contents.tableBtnIcon == 0" type="danger" size="mini"
