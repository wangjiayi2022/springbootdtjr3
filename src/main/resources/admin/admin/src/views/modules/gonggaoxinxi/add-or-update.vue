  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="select" v-if="type!='info'" label="奖学金名称" prop="jiangxuejinmingcheng">
            <el-select @change="jiangxuejinmingchengChange" v-model="ruleForm.jiangxuejinmingcheng"
                       placeholder="请选择奖学金名称">
              <el-option
                  v-for="(item,index) in jiangxuejinmingchengOptions"
                  v-bind:key="index"
                  :label="item"
                  :value="item">
              </el-option>
          ...
          <div v-else>
            <el-form-item class="input" v-if="ruleForm.jiangxuejinmingcheng" label="奖学金名称" prop="jiangxuejinmingcheng">
...
export default {
  ...
  methods: {
    ...
    init(id, type) {
      ...
      this.$http({
        url: `option/jiangxuejinxinxi/jiangxuejinmingcheng`,
        method: "get"
      }).then(({data}) => {
        if (data && data.code === 0) {
          this.jiangxuejinmingchengOptions = data.data;
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    xueshengzhanghaoChange() {
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          if (data.data.jiangxuejinleixing) {
            this.ruleForm.jiangxuejinleixing = data.data.jiangxuejinleixing
          }
          if (data.data.jiangjin) {
            this.ruleForm.jiangjin = data.data.jiangjin
          }
        } else {
          this.$message.error(data.msg);
        }
    ...
    // 下二随
    jiangxuejinmingchengChange() {
      this.$http({
        url: `follow/jiangxuejinxinxi/jiangxuejinmingcheng?columnValue=` + this.ruleForm.jiangxuejinmingcheng,
        method: "get"
      }).then(({data}) => {
        if (data && data.code === 0) {
          if (data.data.xueshengxingming) {
